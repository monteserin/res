...
var btnParaApostar_col1 = document.querySelector(
  ".dddStandard-wrapper :nth-of-type(43)"
);
var btnParaApostar_col2 = document.querySelector(
  ".dddStandard-wrapper :nth-of-type(44)"
);
var btnParaApostar_col3 = document.querySelector(
...
if (document.querySelector(identificadorLetrero) == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el letrero");
}

if (btnParaApostar_red == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar a rojo");
}

if (btnParaApostar_black == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar a negro");
}
if (btnParaApostar_50Centimos == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 50 centimos");
}

if (btnParaApostar_1Euro == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 1 euro");
}

if (btnParaApostar_5Euros == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 5 euros");
}

if (btnParaApostar_25Euros == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 25 euros");
}

if (btnParaApostar_100Euros == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 100 euros");
}

if (btnParaApostar_500Euros == null) {
  console.log("OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar 500 euros");
}

if (btnParaApostar_col1 == null) {
  console.log(
    "OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar a la columna 1"
  );
}

if (btnParaApostar_col2 == null) {
  console.log(
    "OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar a la columna 2"
  );
}

if (btnParaApostar_col3 == null) {
  console.log(
    "OJO!!! no se estÃ¡ cogiendo el botÃ³n para apostar a la columna 3"
  );
}
...
var apostarDinero = function () {
  ...
  const botonesParaApostarEscogidos =
    getBotonParaApostarEnFuncionDelLaOpcionALaQueApostar();
...
var hacerClickEnCantidadAApostar = (
  tipoDeClick,
  numeroDeClicks,
  btnApuestaDinero,
  ...
  console.warn(
    "tipoDeClick: " + tipoDeClick + ", numeroDeClicks: " + numeroDeClicks
  );
  if (apostarHabilitado) {
    // Seleccionamos la cantidad a apostar (esto todavÃ­a no materializa la apuesta)
    console.warn(
      "btnApuestaDinero: " + btnApuestaDinero.getAttribute("data-value")
    );
    simulateClick(btnApuestaDinero);
    setTimeout(function () {
      hacerClickEnOpcionDeApuesta(
        numeroDeClicks,
        btnParaApostarEscogido,
        apostarHabilitado
      );
  ...
  // pulsamos sobre el botÃ³n de apuesta
};

var hacerClickEnOpcionDeApuesta = (
  numeroDeClicks,
  btnParaApostarEscogido,
  apostarHabilitado
) => {
  for (var i = 0; i < numeroDeClicks; i++) {
    if (apostarHabilitado) {
      console.warn(
        "btnParaApostarEscogido: " +
          btnParaApostarEscogido.getAttribute("data-bet-spot-id")
      );
      ...
      if (letreroTxt.includes(letreroParaApostar)) {
        ...
        if (
          ...
          if (mode == martingala || mode == labouchere) {
            ...
            mode == martingalaColumnas1 ||
            mode == martingalaColumnas2
          ) {
          ...
          if (!primeraVez) {
            ...
            if (opcionEscogida == opcionQueSalio) {
              console.log("*** Ù©(^â€¿^)Û¶ APUESTA GANADA Ù©(^â€¿^)Û¶ ***");
              ...
              if (mode == martingala) {
                ...
                if (
                  plantillaArrayLabouchere.length == 1 ||
                  plantillaArrayLabouchere == 2
                ) {
              ...
              console.log("*** (à²¥ï¹à²¥) APUESTA PERDIDA. (à²¥ï¹à²¥) ***");
              numeroDeVecesQuePerdimos += 1;
              if (mode == labouchere) {
                if (plantillaArrayLabouchere.length == 1) {
                  plantillaArrayLabouchere.push(plantillaArrayLabouchere[0]);
                } else {
                  plantillaArrayLabouchere.push(
                    plantillaArrayLabouchere[0] +
                      plantillaArrayLabouchere[
                        plantillaArrayLabouchere.length - 1
                      ]
                  );
                }
          ...
          if (
            ((mode == martingala || mode == labouchere) && opcionQueSalio) ||
            ((mode == martingalaColumnas1 || mode == martingalaColumnas2) &&
              opcionQueSalio &&
              opcionQueSalioAntes &&
              opcionQueSalio != opcionQueSalioAntes)
          ) {
            primeraVez = false;
          }
...
var getCantidadAApostar = () => {
  ...
  if (numeroDeVecesQuePerdimos > 0) {
    if (
      ...
      v =
        plantillaArrayLabouchere[0] +
        plantillaArrayLabouchere[plantillaArrayLabouchere.length - 1];
    }
  } else {
    v = plantillaArray[0];
  }
  ...
  console.log(
    "NÃºmero de veces que perdimos: " +
      numeroDeVecesQuePerdimos +
      "-------- Importe apuesta: " +
      v
  );
