...
<head>
	<meta charset="UTF-8">
	<title>Plantilla con idiomas manteniendo en PHP</title>
			<meta name="description" content="Ejemplo de plantilla básica hecha con PHP que mantiene el idioma seleccionado a lo largo de las diferentes páginas">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1>Plantilla utilizando la instrucción include hecha con PHP</h1>
			</div>
		</div>
