...
<head>
	<meta charset="UTF-8">
	<title>plantilla con detección de idiomas en PHP | Pablo Monteserín</title>
			<meta name="description" content="Ejemplo de plantilla básica hecha con PHP con capacidad para detectar el idioma del navegador">
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h1>Plantilla PHP con detección de idiomas</h1>
			</div>
		</div>
