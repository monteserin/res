...
<head>
	<meta charset="UTF-8">
	<title>plantilla de contenido 1 con includes en PHP</title>
...
<div id="wrapper" style="width:400px">
	...
	<div id="segundaFila"style="float:left">
		...
		<div id="contenido" style="background-color:orange; float:left;width:300px; height:400px">
			<div id="contenidoInt" style="width:100%; height:100%; background-color:green">
	<h1>Uso de la instrucción include de PHP para cargar módulos dentro de una página</h1>
