...
/*
	...
	- Indicar cuando un número salió en las 4 últimas tiradas: 1 hora 30 min
...
var apostarHabilitado = false;
var plantillaArray = [0.5];
var stoploss = 300;
var longitudMaxArray = 5;
...
// Variables para la gestion de los 4 últimos números que salieron:
var ultimos4 = [];
var posCurrent = 0;
var ultimoNumeroRepetido = null;
...
var gestionRepetidos = (nQueSalio, colorQueSalio) => {
	...
	var salioAlgunNumeroRepetidoEnEsteGiro = false;
	
	ultimos4.forEach(n => {
		
		if (combinacionQueSalio == n) {
			girosDesdeElUltimoRepetido = 0;
			ultimoNumeroRepetido = combinacionQueSalio;
			salioAlgunNumeroRepetidoEnEsteGiro = true;
			console.log('**** HAY UN NUEVO NÚMERO QUE HA SALIDO REPETIDO EN ESTE GIRO: ' + combinacionQueSalio);
		}
	});
	ultimos4[posCurrent] = combinacionQueSalio;

	if (ultimoNumeroRepetido != null) {
		if (ultimoNumeroRepetido > 0) {
			console.log('Van ' + girosDesdeElUltimoRepetido + ' desde la última vez que salió el ' + ultimoNumeroRepetido);
		}
