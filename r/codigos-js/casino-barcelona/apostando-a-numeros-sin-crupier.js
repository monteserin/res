...
var letrerosParaEsperar = ['APUESTAS CERCA DEL CIERRE', 'NO HAY MÁS APUESTAS', 'ESPERANDO LA SIGUIENTE PARTIDA', 'APUESTAS ACEPTADAS', 'CERRANDO APUESTAS', 'APUESTAS CERRADAS', 'NO MORE BETS', 'RONDA RELÁMPAGO','Ronda Relámpago', 'HAGA SUS APUESTAS'];
				...
				if (!letrerosParaEsperar.includes(letreroTxt) && estado == 'esperandoParaVerSiGane') {
					...
					if (!primeraVez) {
						...
						if (evaluarApuesta(opcionQueSalio, opcionEscogida)) {
							var dineroGanadoEnEsteGiro = 18-cantidadAAPostarTotal;
							dineroGanado +=18
