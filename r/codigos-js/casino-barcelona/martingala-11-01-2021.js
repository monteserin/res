...
var getBotonParaApostarEnFuncionDelLaOpcionALaQueApostar = opcionEscogida => {
...
var hacerClick = (tipoDeClick, numeroDeClicks, btnApuestaDinero, btnParaApostarEscogido) => {
	console.log('ooooooooo' + btnParaApostarEscogido)
