...
<head>
	<meta charset="UTF-8">
	<title>modificación cargar fecha hospital | Pablo Monteserín</title>
</head>
<body>
<?php
...
Fecha alta:<input type="text" size="2" value="<?php echo $fechaExplotada[2]?>">
<input type="text" size="2" value="<?php echo $fechaExplotada[1]?>">
<input type="text" size="4" value="<?php echo $fechaExplotada[0]?>">
