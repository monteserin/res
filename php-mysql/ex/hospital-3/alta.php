...
<head>
	<meta charset="UTF-8">
	<title>alta registro hospital en PHP | Pablo Monteserín</title>
			  <meta name="description" content="Alta de un paciente en una base de datos MySQL, insertando su nombre,apellidos y la fecha de alta. El lenguaje de programación utilizado será PHP">
