...
<head>
	<meta charset="UTF-8">
	<title>baja registro hospital en PHP| Pablo Monteserín</title>
		  <meta name="description" content="Eliminación de un registro de una base de datos de pacientes de un hospital. Seleccionaremos un registro de una combo desplegable y para eliminarlo">
