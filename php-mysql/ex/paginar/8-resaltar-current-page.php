...
<head>
	<meta charset="UTF-8">
	<title>paginar en PHP resaltando la página actual</title>
    <meta name="description" content="Ejemplo de paginación con PHP haciendo una consulta a una base de datos MySQL con registros de jugadores de futbol">

</head>
<body>
<h1>Paginación con PHP de los registros de una base de datos MySQL</h1>
<?php
